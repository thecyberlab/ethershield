...
for train_index, test_index in skf.split(features, feature_label):
    ...
    rf_clf = RandomForestClassifier(criterion = 'gini', max_features = 'sqrt', min_samples_leaf = 1, min_samples_split = 2, n_estimators = 115)
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('RT: binary_transaction_only: ' + str(mean(temp_accuracy_list)) + '\n')

df = pd.read_csv(binary_csv, dtype=dtype_dict)
status_dict=df['category'].unique().tolist()
df['transformed']=df['category'].apply(lambda x:status_dict.index(x))
new_df = df.drop(['category'], axis=1)
features = df[feature_set_ngram_bytecode]
feature_label = df['transformed']
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('RT: binary_bytecode: ' + str(mean(temp_accuracy_list)) + '\n')

df = pd.read_csv(binary_csv, dtype=dtype_dict)
status_dict=df['category'].unique().tolist()
df['transformed']=df['category'].apply(lambda x:status_dict.index(x))
new_df = df.drop(['category'], axis=1)
features = df[feature_set_opcode_tf_idf]
feature_label = df['transformed']
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('RT: binary_opcodes: ' + str(mean(temp_accuracy_list)) + '\n')

df = pd.read_csv(binary_csv, dtype=dtype_dict)
status_dict=df['category'].unique().tolist()
df['transformed']=df['category'].apply(lambda x:status_dict.index(x))
new_df = df.drop(['category'], axis=1)
features = df[feature_set_operands_tf_idf]
feature_label = df['transformed']
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('RT: binary_operands: ' + str(mean(temp_accuracy_list)) + '\n')

df = pd.read_csv(binary_csv, dtype=dtype_dict)
status_dict=df['category'].unique().tolist()
df['transformed']=df['category'].apply(lambda x:status_dict.index(x))
new_df = df.drop(['category'], axis=1)
features = df[feature_set_ngram_all]
feature_label = df['transformed']
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('RT: binary_opcode_and_operands: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('RT: binary_all: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('RT: multi_transaction_only: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('RT: multi_bytecode: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('RT: multi_opcodes: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('RT: multi_operands: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('RT: multi_opcode_and_operands: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('RT: multi_all: ' + str(mean(temp_accuracy_list)) + '\n')
...
for train_index, test_index in skf.split(features, feature_label):
    ...
    l_train = np.nan_to_num(l_train.astype(np.float32))
    l_test = np.nan_to_num(l_test.astype(np.float32))
    dt_clf = DecisionTreeClassifier(criterion = 'log_loss', max_depth = 13, min_samples_leaf = 3, min_samples_split = 17, splitter = 'best')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('DT: binary_transaction_only: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('DT: binary_bytecode: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('DT: binary_opcodes: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('DT: binary_operands: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('DT: binary_opcode_and_operands: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('DT: binary_all: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('DT: multi_transaction_only: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('DT: multi_bytecode: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('DT: multi_opcodes: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('DT: multi_operands: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('DT: multi_opcode_and_operands: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('DT: multi_all: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('XGBoost: binary_transaction_only: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('XGBoost: binary_bytecode: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('XGBoost: binary_opcodes: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('XGBoost: binary_operands: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('XGBoost: binary_opcode_and_operands: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('XGBoost: binary_all: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('XGBoost: multi_transaction_only: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('XGBoost: multi_bytecode: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('XGBoost: multi_opcodes: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('XGBoost: multi_operands: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('XGBoost: multi_opcode_and_operands: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('XGBoost: multi_all: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('LightGBM: binary_transaction_only: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('LightGBM: binary_bytecode: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('LightGBM: binary_opcodes: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('LightGBM: binary_operands: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('LightGBM: binary_opcode_and_operands: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('LightGBM: binary_all: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('LightGBM: multi_transaction_only: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('LightGBM: multi_bytecode: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('LightGBM: multi_opcodes: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('LightGBM: multi_operands: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('LightGBM: multi_opcode_and_operands: ' + str(mean(temp_accuracy_list)) + '\n')
...
with open('baseline.txt', 'a') as newfile:
    newfile.write('LightGBM: multi_all: ' + str(mean(temp_accuracy_list)) + '\n')