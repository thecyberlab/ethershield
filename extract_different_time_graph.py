...
out_time_list = [' (1hours)', ' (3hours)', ' (6hours)', ' (12hours)', ' (1.0days)', ' (3.0days)', ' (7.0days)', ' (14.0days)', ' (30.0days)', ' (90.0days)', ' (180.0days)', ' (365.0days)', ' (1095.0days)', ' (1825.0days)', ' (3650.0days)']
...
xgboost_multi_different_time = []
i = 0
j = 0
for current_our_str in out_time_list:
    ...
    time_current = current_our_str
    original_time_list = time_list.copy()
    time_list.remove(current_our_str)
    new_time_list = time_list.copy()
    time_list = original_time_list.copy()
    ...
    for time in new_time_list:
        ...
        temp_str = ''
        for each_str in without_time_list:
            temp_str = each_str + time_current
            temp_list.append(temp_str)
        features = df[temp_list + feature_set_opcode_tf_idf + feature_set_ngram_bytecode + feature_set_ngram_all + feature_set_operands_tf_idf]
        temp_accuracy_list = []
        for train_index, test_index in skf.split(features, feature_label):
            ...
            original_df = df
            df = df.drop(labels=temp_list, axis=1)
            for each_str in without_time_list:
                df = df.rename(columns={each_str + time: each_str + time_current})
            features = df[temp_list + feature_set_opcode_tf_idf + feature_set_ngram_bytecode + feature_set_ngram_all + feature_set_operands_tf_idf]
            ...
            l_pred = xgb_clf.predict(f_test)
            df = original_df
            temp_accuracy_list.append(accuracy_score(l_test, l_pred))
        xgboost_multi_different_time.append(mean(temp_accuracy_list))
        print(xgboost_multi_different_time)
    print("end of different!")
    ...
    for train_index, test_index in skf.split(features, feature_label):
        f_train, l_test = features.iloc[train_index], features.iloc[test_index]
        l_train, l_test = feature_label.iloc[train_index], feature_label.iloc[test_index]
        f_test = features.iloc[test_index]
        xgb_clf = xgb.XGBClassifier(gamma= 0, max_delta_step= 0, max_depth= 7, min_child_weight= 5)
        xgb_clf.fit(f_train, l_train)
        l_pred = xgb_clf.predict(f_test)
        temp_accuracy_list.append(accuracy_score(l_test, l_pred))
    xgboost_multi_different_time.insert(i, mean(temp_accuracy_list))
    j = j + 1
    i = j + 15 * j
...
for current_our_str in out_time_list:
    ...
    for time in new_time_list:
        ...
        for train_index, test_index in skf.split(features, feature_label):
            ...
            df = original_df
            temp_accuracy_list.append(accuracy_score(l_test, l_pred))
        xgboost_binary_different_time.append(mean(temp_accuracy_list))
        print(xgboost_binary_different_time)
    ...
    for train_index, test_index in skf.split(features, feature_label):
        ...
        l_pred = xgb_clf.predict(f_test)
        temp_accuracy_list.append(accuracy_score(l_test, l_pred))
    xgboost_binary_different_time.insert(i, mean(temp_accuracy_list))
    j = j + 1
    i = j + 15 * j

with open('xgboost_different_time.txt', 'a') as newfile:
    newfile.write('xgboost_multi_different_time:' + str(xgboost_multi_different_time) + '\n')
with open('xgboost_different_time.txt', 'a') as newfile:
    newfile.write('xgboost_binary_different_time:' + str(xgboost_binary_different_time) + '\n')

names = ['1hour', '3hours', '6hours', '12hours', '1day', '3days', '7days', '14days', '30days', '90days', '180days', '365days', '3years', '5years', '10years']
x = range(len(names))
plt.plot(x, xgboost_multi_different_time[0:15], marker='.', label='Training by 1hour data')
plt.plot(x, xgboost_multi_different_time[15:30], marker='o', label='Training by 3hours data')
plt.plot(x, xgboost_multi_different_time[30:45], marker='v', label='Training by 6hours data')
plt.plot(x, xgboost_multi_different_time[45:60], marker='^', label='Training by 12hours data')
plt.plot(x, xgboost_multi_different_time[60:75], marker='<', label='Training by 1day data')
plt.plot(x, xgboost_multi_different_time[75:90], marker='>', label='Training by 3days data')
plt.plot(x, xgboost_multi_different_time[90:105], marker='s', label='Training by 7days data')
plt.plot(x, xgboost_multi_different_time[105:120], marker='p', label='Training by 14days data')
plt.legend()
plt.xticks(x, names, rotation=45)
plt.subplots_adjust(bottom=0.18)
plt.xlabel("Prediction Time")
plt.ylabel("Accuracy")
plt.savefig('different_time_multi_1.png', dpi=300)
#plt.title("A simple plot")
plt.cla()

names = ['1hour', '3hours', '6hours', '12hours', '1day', '3days', '7days', '14days', '30days', '90days', '180days', '365days', '3years', '5years', '10years']
x = range(len(names))
plt.plot(x, xgboost_multi_different_time[120:135], marker='*', label='Training by 30days data')
plt.plot(x, xgboost_multi_different_time[135:150], marker='h', label='Training by 90days data')
plt.plot(x, xgboost_multi_different_time[150:165], marker='+', label='Training by 180days data')
plt.plot(x, xgboost_multi_different_time[165:180], marker='1', label='Training by 1year data')
plt.plot(x, xgboost_multi_different_time[180:195], marker='2', label='Training by 3years data')
plt.plot(x, xgboost_multi_different_time[195:210], marker='|', label='Training by 5years data')
plt.plot(x, xgboost_multi_different_time[210:225], marker='_', label='Training by 10years data')
plt.legend()
plt.xticks(x, names, rotation=45)
plt.subplots_adjust(bottom=0.18)
plt.xlabel("Prediction Time")
plt.ylabel("Accuracy")
plt.savefig('different_time_multi_2.png', dpi=300)

names = ['1hour', '3hours', '6hours', '12hours', '1day', '3days', '7days', '14days', '30days', '90days', '180days', '365days', '3years', '5years', '10years']
x = range(len(names))
plt.plot(x, xgboost_binary_different_time[0:15], marker='.', label='Training by 1hour data')
plt.plot(x, xgboost_binary_different_time[15:30], marker='o', label='Training by 3hours data')
plt.plot(x, xgboost_binary_different_time[30:45], marker='v', label='Training by 6hours data')
plt.plot(x, xgboost_binary_different_time[45:60], marker='^', label='Training by 12hours data')
plt.plot(x, xgboost_binary_different_time[60:75], marker='<', label='Training by 1day data')
plt.plot(x, xgboost_binary_different_time[75:90], marker='>', label='Training by 3days data')
plt.plot(x, xgboost_binary_different_time[90:105], marker='s', label='Training by 7days data')
plt.plot(x, xgboost_binary_different_time[105:120], marker='p', label='Training by 14days data')
plt.legend()
plt.xticks(x, names, rotation=45)
plt.subplots_adjust(bottom=0.18)
plt.xlabel("Prediction Time")
plt.ylabel("Accuracy")
plt.savefig('different_time_binary_1.png', dpi=300)
#plt.title("A simple plot")
plt.cla()

names = ['1hour', '3hours', '6hours', '12hours', '1day', '3days', '7days', '14days', '30days', '90days', '180days', '365days', '3years', '5years', '10years']
x = range(len(names))
plt.plot(x, xgboost_binary_different_time[120:135], marker='*', label='Training by 30days data')
plt.plot(x, xgboost_binary_different_time[135:150], marker='h', label='Training by 90days data')
plt.plot(x, xgboost_binary_different_time[150:165], marker='+', label='Training by 180days data')
plt.plot(x, xgboost_binary_different_time[165:180], marker='1', label='Training by 1year data')
plt.plot(x, xgboost_binary_different_time[180:195], marker='2', label='Training by 3years data')
plt.plot(x, xgboost_binary_different_time[195:210], marker='|', label='Training by 5years data')
plt.plot(x, xgboost_binary_different_time[210:225], marker='_', label='Training by 10years data')
plt.legend()
plt.xticks(x, names, rotation=45)
plt.subplots_adjust(bottom=0.18)
plt.xlabel("Prediction Time")
plt.ylabel("Accuracy")
plt.savefig('different_time_binary_2.png', dpi=300)
#plt.title("A simple plot")

# df = pd.read_csv(multi_csv, dtype=dtype_dict)

# lightgbm_multi_different_time = []
# i = 0
# for current_our_str in time_list:
...
#             df = original_df
#             temp_accuracy_list.append(accuracy_score(l_test, l_pred))
#         lightgbm_multi_different_time.append(mean(temp_accuracy_list))
#         print(lightgbm_multi_different_time)
...
#         l_predict = lgb_clf.predict(f_test)
#         temp_accuracy_list.append(accuracy_score(l_test, l_pred))
#     lightgbm_multi_different_time.insert(i, mean(temp_accuracy_list))
#     i = i + 1


# df = pd.read_csv(binary_csv, dtype=dtype_dict)

# lightgbm_binary_different_time = []
# i = 0
# for current_our_str in time_list:
...
#             df = original_df
#             temp_accuracy_list.append(accuracy_score(l_test, l_pred))
#         lightgbm_binary_different_time.append(mean(temp_accuracy_list))
#         print(lightgbm_binary_different_time)
...
#         l_predict = lgb_clf.predict(f_test)
#         temp_accuracy_list.append(accuracy_score(l_test, l_pred))
#     lightgbm_binary_different_time.insert(i, mean(temp_accuracy_list))
#     i = i + 1