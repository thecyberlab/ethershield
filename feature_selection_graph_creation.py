...
for time in time_list:
    ...
    count = 10
    while count <= top_many:
        top_ranked_list = ranked_list[0:count]

        df = pd.read_csv(binary_csv, dtype=dtype_dict)
        status_dict=df['category'].unique().tolist()
        df['transformed']=df['category'].apply(lambda x:status_dict.index(x))
        new_df = df.drop(['category'], axis=1)
        features = df[top_ranked_list]
        feature_label = df['transformed']
        ...
        accuracy_list.append(mean(temp_accuracy_list))
        count = count + 10
with open('lightgbm_binary_top_accuracy_200.txt', 'a') as newfile:
    newfile.write(name + ' ' + str(accuracy_list) + '\n')

names = ['Top10', 'Top20', 'Top30', 'Top40', 'Top50', 'Top60', 'Top70', 'Top80', 'Top90', 'Top100', 'Top110', 'Top120', 'Top130', 'Top140', 'Top150', 'Top160', 'Top170', 'Top180', 'Top190', 'Top200']
a_1_hour = accuracy_list[0:20]
a_3_hours = accuracy_list[20:40]
a_6_hours = accuracy_list[40:60]
a_12_hours = accuracy_list[60:80]
a_1_day = accuracy_list[80:100]
a_3_days = accuracy_list[100:120]
a_7_days = accuracy_list[120:140]
a_14_days = accuracy_list[140:160]
a_30_days = accuracy_list[160:180]
a_90_days = accuracy_list[180:200]
a_180_days = accuracy_list[200:220]
a_1_year = accuracy_list[220:240]
a_3_years = accuracy_list[240:260]
a_5_years = accuracy_list[260:280]
a_10_years = accuracy_list[280:300]

x = range(len(names))
plt.plot(x, a_1_hour, marker='.', label='1hour')
plt.plot(x, a_3_hours, marker='o', label='3hours')
plt.plot(x, a_6_hours, marker='v', label='6hours')
plt.plot(x, a_12_hours, marker='^', label='12hours')
plt.plot(x, a_1_day, marker='<', label='1day')
plt.plot(x, a_3_days, marker='>', label='3days')
plt.plot(x, a_7_days, marker='s', label='7days')
plt.plot(x, a_14_days, marker='p', label='14days')
plt.plot(x, a_30_days, marker='*', label='30days')
plt.plot(x, a_90_days, marker='h', label='90days')
plt.plot(x, a_180_days, marker='+', label='180days')
plt.plot(x, a_1_year, marker='1', label='1year')
plt.plot(x, a_3_years, marker='2', label='3years')
plt.plot(x, a_5_years, marker='|', label='5years')
plt.plot(x, a_10_years, marker='_', label='10years')
plt.legend()
...
plt.savefig('lg_binary_feature.png', dpi=300)
...
for time in time_list:
    ...
    while count <= top_many:
        ...
        accuracy_list.append(mean(temp_accuracy_list))
        count = count + 10
with open('lightgbm_multi_top_accuracy_200.txt', 'a') as newfile:
    newfile.write(name + ' ' + str(accuracy_list) + '\n')
...
plt.legend(bbox_to_anchor=(1.05,1))
plt.subplots_adjust(right=0.78)
plt.savefig('lg_multi_feature.png', dpi=300)
...
for time in time_list:
    ...
    while count <= top_many:
        ...
        accuracy_list.append(mean(temp_accuracy_list))
        count = count + 10
with open('xgboost_binary_top_accuracy_200.txt', 'a') as newfile:
    newfile.write(name + ' ' + str(accuracy_list) + '\n')
...
plt.legend(bbox_to_anchor=(1.05,1))
plt.subplots_adjust(right=0.78)
plt.savefig('xg_binary_feature.png', dpi=300)
...
for time in time_list:
    ...
    while count <= top_many:
        ...
        accuracy_list.append(mean(temp_accuracy_list))
        count = count + 10
with open('xgboost_multi_top_accuracy_200.txt', 'a') as newfile:
    newfile.write(name + ' ' + str(accuracy_list) + '\n')
...
plt.legend(bbox_to_anchor=(1.05,1))
plt.subplots_adjust(right=0.78)
plt.savefig('xg_multi_feature.png', dpi=300)